...
const akatsukiParticles = {
  particles: {
    ...
    shape: {
      ...
      stroke: { width: 0, color: '#e31b6d' },
      polygon: { nb_sides: 5 },
      image: { src: 'images/akatsuki-2.webp', width: 100, height: 60 },
    },
    opacity: { value: 1, random: true, anim: { enable: true, speed: 1, opacity_min: 0, sync: false } },
    size: { value: 20, random: true, anim: { enable: false, speed: 4, size_min: 0.3, sync: false } },
    line_linked: { enable: false, distance: 150, color: '#ffffff', opacity: 0.4, width: 1 },
    move: {
      enable: true,
      speed: 1,
...
const shinyPokemonParticles = {
  particles: {
    ...
    opacity: { value: 1, random: true, anim: { enable: true, speed: 1, opacity_min: 0, sync: false } },
    size: { value: 50, random: true, anim: { enable: false, speed: 4, size_min: 0.3, sync: false } },
    line_linked: { enable: false, distance: 150, color: '#ffffff', opacity: 0.4, width: 1 },
    move: {
      enable: true,
      speed: 1,
...
const catchPokemon = () => {
  ...
  currentPoke = JSON.stringify({ name: name.textContent, sprite: image.src });
